...
import static interviews.mower.direction.DirectionLabel.E;

public class East implements Direction {

    private static final DirectionLabel LABEL = E;

    @Override
    public void execute(Mower mower, Lawn lawn) {
        Coordinate actualCoordinate = mower.getCoordinate();
        Coordinate nextCoordinate = new Coordinate(actualCoordinate.getX() + 1, actualCoordinate.getY());
